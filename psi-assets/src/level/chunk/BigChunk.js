...
BigChunk.prototype.build = function() {
    this.items = [
		...
		{time:1.7, action:function(game){ game.makeBaddie( new Baddie(new THREE.Vector3(100,800,0), 30, 1) ) } },
        {time:2.0, action:function(game){ game.makeBaddie( new Baddie(new THREE.Vector3(-200,800,0), 30, 3) ) } },
		{time:2.2, action:function(game){ game.makeBaddie( new Baddie(new THREE.Vector3(-200,800,0), 30, 3) ) } },
		{time:2.5, action:function(game){ game.makeBaddie( new Baddie(new THREE.Vector3(250,800,0), 30, 5) ) } },
		{time:2.8, action:function(game){ game.makeBaddie( new Baddie(new THREE.Vector3(-400,800,0), 30, 5) ) } },
        ...
        {time:3.5, action:function(game){ game.makeBaddie( new Baddie(new THREE.Vector3(0,800,0), 30, 8) ) } },
        {time:4.0, action:function(game){ game.makeBaddie( new Baddie(new THREE.Vector3(-200,800,0), 30, 2) ) } },
		{time:4.1, action:function(game){ game.makeBaddie( new Baddie(new THREE.Vector3(200,800,0), 30, 2) ) } },
       
        {time:4.5, action:function(game){ game.makeBaddie( new Baddie(new THREE.Vector3(250,800,0), 30, 4) ) } },
		{time:4.5, action:function(game){ game.makeBaddie( new Baddie(new THREE.Vector3(0,800,0), 30, 4) ) } },
        {time:5.0, action:function(game){ game.makeBaddie( new Baddie(new THREE.Vector3(200,800,0), 30, 2) ) } },
		{time:5.5, action:function(game){ game.makeBaddie( new Baddie(new THREE.Vector3(250,800,0), 30, 2) ) } },
		{time:5.5, action:function(game){ game.makeBaddie( new Baddie(new THREE.Vector3(0,800,0), 30, 8) ) } },
