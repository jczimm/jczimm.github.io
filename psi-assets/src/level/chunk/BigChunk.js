...
BigChunk.prototype.build = function() {
    this.items = [
        ...
        {time:1.5, action:function(game){ game.makeBaddie( new Baddie(new THREE.Vector3(-200,800,0), 30, 1) ) } },
        {time:2.0, action:function(game){ game.makeBaddie( new Baddie(new THREE.Vector3(-200,800,0), 30, 1) ) } },
		{time:2.5, action:function(game){ game.makeBaddie( new Baddie(new THREE.Vector3(-200,800,0), 30, 6) ) } },

        {time:3.0, action:function(game){ game.makeBaddie( new Baddie(new THREE.Vector3(100,800,0), 30, 2) ) } },
        {time:3.5, action:function(game){ game.makeBaddie( new Baddie(new THREE.Vector3(100,800,0), 30, 2) ) } },
        {time:4.0, action:function(game){ game.makeBaddie( new Baddie(new THREE.Vector3(100,800,0), 30, 7) ) } },
       
        {time:4.5, action:function(game){ game.makeBaddie( new Baddie(new THREE.Vector3(250,800,0), 30, 3) ) } },
        {time:5.0, action:function(game){ game.makeBaddie( new Baddie(new THREE.Vector3(250,800,0), 30, 3) ) } },
